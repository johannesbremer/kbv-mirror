...
REM set dir=C:\java\xerces-2_12_2
set dir=C:\JAVA\fop-2.7\fop\lib

REM set ENV=-cp .;%dir%\xercesImpl.jar;%dir%\xercesSamples.jar;%dir%\xml-apis.jar;%dir%\resolver.jar;
set ENV=-cp .;%dir%\xercesImpl-2.12.0.jar;%dir%\xml-apis-1.4.01.jar;
