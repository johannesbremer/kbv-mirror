...
| 1.21L | 10.02.2020 | kv.digital GmbH | Umfirmung KV Telematik GmbH in kv.digital GmbH Anpassung URL Schlüsseltabellen der KBV |  | Alle 68 |
|---|---|---|---|---|---|
| 1.21L | 30.01.2019 | KV Telematik GmbH | Lizenzbestimmungen |  | 3 |
| 1.21 | 11.11.2014 |  | Redaktionelle Änderungen |  |  |
| 1.21 | 31.12.2013 |  | Neues Element angestel- ler_arzt_liste aufgenommen | Neue Anforderung |  |
| 1.20 1.10 | 18.11.2010 |  | Generische Ausrichtung der Strukturen Berücksichtigung weiterer An- forderungen | gesteigerte Wiederverwendbar- keit Kommentierungsphase |  |
...
**L I Z E N Z B E S T I M M U N G E N**  **Herausgeber:** kv.digital GmbH  **Lizenzbestimmungen**  für die unentgeltliche Nutzung von Spezifikationen der kv.digital GmbH, Herbert-Lewin- Platz 2, 10623 Berlin („Lizenzgeberin“)  1.Vertragsgegenstand 1.1. Die Lizenzgeberin hat für verschiedene ihrer Anwendungen Spezifikationen erstellt („Werke“), die sie unentgeltlich z Praxisverwaltungs-, Labor- oder Krankenhausinformationssysteme) durch interessierte Dritte zur Verfügung stellt.
...
ur Implementierung in Primärsysteme (z.B.
...
nznehmer Kaufmann, eine juristische Person
...
4.7.1 organization......................................................................................................................... 19 *4.7.1.1**id (Identifikator)**..................................................................................................... 20* *4.7.1.2**organization.nm (organisationsname)* *4.7.1.3**addr (Adresse)**...................................................................................................... 21* *4.7.1.4**telecom**................................................................................................................. 22*
...
**I****N****H****A****L****T****S****V****E****R****Z****E****I****C****H****N****I****S**  4.8.3 telecom................................................................................................................................ 26

4.8.4 local_header (lokale Erweiterungen)................................................................................... 26 *4.8.4.1**fachgruppenbezeichnung (Fachgruppenbezeichnung)*
...
5.2.1 bool_komplex (Entscheidungsbaum - komplex) *5.2.1.1**komplex..................................................................................................................37*
...
**5.7****praxisgemeinschaft_liste (Dokumentation einer Praxisgemeinschaft)**

**5.8****bestaetigungen (Rechtsverbindliche Erklärungen)**

5.8.1 abrechnung_erklaerung (Erklärung zur Abrechnung) *5.8.1.1**bool_einfach (Entscheidungsbaum - einfach) .......................................................51*

5.8.2 ueberweisungsscheine (Erklärung zur Abrechnung

5.8.3 abrechnung_edv (Erklärung zurEDV-gestützten Abrechnung) ...........................................53 *5.8.3.1**bool_software (Entscheidungsbaum - Softwareeinsatz) .......................................54*

5.8.4 abrechnung_allgemeinlabor (Erklärung zum Allgemeinlabor) *5.8.4.1**bool_labor (Entscheidungsbaum - Allgemeinlabor)*
...
von Überweisungsscheinen)

..............................................56 *...............................................57*

hoher Komplexität..........................................62
...
**I****N****H****A****L****T****S****V****E****R****Z****E****I****C****H****N****I****S**  **6****QUELLENVERWEISE**
...
**A B B I L D U N G S V E R Z E I C H N I S**  Abbildung 1:
...
Verzweigung im Entscheidungsbaum „true“
...
Entscheidungsbaum mit Verzweigung „true“

abrechnung_allgemeinlabor

bool_labor

Entscheidungsbaum Allgemeinlabor <true>
...
**T A B E L L E N V E R Z E I C H N I S**  Tabelle 1:
...
Beispiel für eine generische Bestätigung
...
-Schemata sowie die projektbezogenen bo
...
tf+..………… timeframe (YYYYqQ); Angabe von Jahr und Quartal, für das di
...
Satzart „ese“, entspricht dem Header
...
- (optionaler Namepart) Empfänger der Lieferung, falls die Lieferung für

die Sammelerklärung für einen speziellen Empfängerkreis (Arzt, Er
...
|---|---|---|
| n...m |  | Mehrfache Elemente Bei Elementen, welche m ehrfach vorkommen kön - nen, wird die erlaubte Anzahl rechts unter dem Sym - bol dargestellt. Die Werte können von 0 bis  (un- bounded) reichen. |

**Tabelle 1:**  **2.5.2 Strukturelemente**

Die Elemente eines Schema-Diagramms werden über sogenannte Strukturelemente mitei- nander verknüpft. In diesem Dokument werden zwei Strukturelemente v und <xs:sequence>.

| Symbol | Beschreibung |
|---|---|
|  | Das Strukturelement <xs:choice> zeigt an, dass zwischen verschiedenen Kin - delementen genau eins ausgewählt werden muss. |
|  | Das Strukturelement <xs:sequence> beschreibt, dass die Kindelemen te in fest- gelegter Reihenfolge aufgeführt werden müssen. |
...
|  | Referenzelement Der Pfeil links unten im Element zeigt an, dass das Element an ande - rer Stelle im Schema definiert wurde. |
...
Dieses Element ist das Wurzelelement der Schnittstelle. Es beinhaltet die Kindelemente „hea der“ und „body“, stehen die eigentlichen Daten hinterlegt.
...
wiees in Abbildung 1: /ehd (root spezifischen Informationen
...
-Element) dargestellt ist. Im header zurSchnittstelle.
...
**Abbildung 3:**  Der XML-Code für das Element <id> hat folgenden Aufbau: **<ehd:id EX="2" RT="123456789"/>**

**XML-Code 2:**   EXLaufende Nummer

RTLANR

RTVoptional: Versionsangabe

### 4.2

### version_nbr (Lieferungsnummer)

Das Element <version_nbr > enthält di

**Abbildung 4:**  Der XML-Code für das Element <version_nbr> hat folgenden Aufbau: **<ehd:version_nbr V="1"/>**

**XML-Code 3:**   VLieferungsnummer

Schnittstellenbeschreibung Elektronische Sammelerklärung (eSE)

hang ein Quartalsbezug im Format JJJJ

Gibt das Erstellungsdatum des Dokumentes an.

Angabe eines bestimmten Empfängerkreises; insbesondere relevant, wenn Datenlieferung über Zwischenstationen

Urheber des Dokuments (Standard:

Bereitsteller des Dokuments (Standard: Arztpraxis)

Informationen zur verwendeten Schnittstelle; insbes. Name und
...
**XML-Code 4:**   VDokumenttyp: ese

Soptional: (1.2.276.0.76.5.100)

DNoptional: Dokumenttyp im Klartext

SVoptional: Version der Schlüsseltabelle

SNoptional: Name der Schlüsseltabelle
...
**XML-Code 5:**   V:hier wird der Gültigkeitszeitraum z.B. im Format „YYYY geben.
...
mitallenDokumenttypen

bau:

-MM-DD..YYYY-MM- DD“ ange
...
**XML-Code 6:**   VErstellungsdatum der Datei im Format „YYYY
...
**XML-Code 9:**  VName der Organisationseinheit; zulässig sind die Ausprägungen Arzt, Ermächtigt, Krankenhaus   Hinweis:
...
**Abbildung 11: originator**  Der XML-Code für das Element <originator> hat folgenden Aufbau:  **<ehd:originator>** **<ehd:organization>**

**</ehd:organization>**

</ehd:originator>

**XML-Code 10:**  ***<organization>***

**4.7.1 organization**

Unter dem Element <organization> werden die Eigenschaften einer Organisation definiert. Eine KV ist bspw. eine Organisation.

**Abbildung 12:**  Der XML-Code für das Element <organization> hat folgenden Aufbau:  **<ehd:organization>** **<ehd:id EX="38" RT="1.2.276.0.76.5.233"/>** **<ehd:organization.nm V="Kassenärztliche Vereinigung Nordrhein"/>**
...
Strukturelement der Urheber-Organisation (KV)
...
**Abbildung 17:**  Der XML-Code für das Element <provider> hat folgenden Aufbau:  **<ehd:provider>**

</ehd:provider>

**XML-Code 16:**   **<person>**

**<organization>**    **4.8.1 person**
...
Der XML-Code für das Element <person> hat folgenden Auf  **<ehd:person>**
...
**<local_header>**    **4.8.1.1**

Zur Identifikation des Arztes wird unter dem Element <id> die LANR erfasst.

**Abbildung 19:**  Der XML-Code für das Element <id> hat folgenden Aufbau:  <ehd:id EX="123456789" RT="1.2.276.0.76.4.16"/>
...
**<ehd:id EX="123456789" RT="1.2.276.0.76.4.16"/>** **<ehd:person_name>** **…** **</ehd:person_name>** **<ehd:local_header>** **…** **</ehd:local_header>**
...
wurdealslokaleErweiterungunterdem<lo- „Arzt“ um eine individuelle Fachgrup-
...
Das <body> Element beinhaltet die Bewegungsda root- Element <ese_data> wird in den lokalen Namensraum „urn:ehd/ese/001“ gewechselt.
...
Der XML-Code für das Element <body> hat folgenden Aufbau:  **<ehd:body>**
...
simplerAnkreuzfeld-Sachverhalte fürjeglicheBestätigungen

-Stylesheets; nur relevant bei
...
optional: Anzahl der BehandlungsfälleGKV

optional: Anzahl der BehandlungsfälleSKT

optional: Anzahl der BehandlungsfälleKOV
...
Mittels dem Element <anzahl_skt> kann eine statistische Angabe über die Anzahl der abge rechneten Behandlungsfälle im Rahmen der Abrechnung ( werden.
...
Sonstige Kostenträger) übertragen
...
**Abbildung 31:**  XML-Beispiel: **<bool_komplex>**
...
**XML-Code 31:****Verzweigung „true“ im Entscheidungsbaum**   **5.2.1.1****komplex** Die Struktur <komplex> erlaubt es, eine beliebige Anzahl von Komplexen zu definieren, die wahlweise ein Datumsintervall, eine Begründung oder einen konkreten Arztbezug abbilden können.
...
**Abbildung 34:**  Der XML-Code für das Element <grund> **<grund V="Urlaub"/>**
...
**<zeitraum_tmr V="2004-01-01..2004-01-15"/>** **<provider>** **…** **</provider>**
...
Lokal eingeschränkter Provider ten und Ärzten
...
Für das V-Attribut sind folgende Ausprägungen e  Krankheit
...
Die Syntax sei an folgendem Beispiel **<zeitraum_tmr V="2010-10-16+16:00..2010-10-17+01:00"/>**

**XML-Code 34:**   **5.2.1.1.3**
...
SV  Das Element <function_cd> referenziert auf eine Schlüsseltabelle mit folgenden Ausprägun- gen. Die dritte Spalte enthält eine Erläuterung, welche Ausprägung in welchen Zusammen- hang verwendet wird.

| Value | Bezeichnung | Schnittstelleninterne Verwendung |
|---|---|---|
| ARZTW | Arztwechsel | - |
| BEHA | Behandelnder Arzt | Kennzeichnet den regelhaft behan- delnden Arzt; spiegelt im aktuellen Kontext den Arzt wieder, der vertre- ten wurde |
| VERTRETER | Vertreterarzt | kennzeichnet den Vertreter -Arzt (Default) |
...
Schließzeitenpersonen-und/oder betriebsstättenbezogen ts <bool_komplex> sei auf Kapitel

Person eine Organisationseinheit angegeben

der Schließung und/oder mit dem jeweiligen

(LANR)

-Attribut als LANR

dokumentiertwerden 5.2.1 ff. verwie-
...
indiesem Sachzusammenhang zwingend
...
**Abbildung 43:**  Der XML-Code der Struktur <bestaetigungen> ist wie folgt aufgebaut: **<bestaetigungen>** **<abrechnung_erklaerung>**

**</abrechnung_erklaerung>** **<ueberweisungsscheine>**

**</ueberweisungsscheine>** **<abrechnung_edv>**
...
Sachverhaltes lärung ist durch die Elemente <titel> und <text_liste> definiert. Die
...
Das Element (bool_einfach_typ). Er kommt zur Anwendung, wenn eine Bestätigung eines Sachverhaltes erforderlich ist und keine Verknüpfung mit weiteren Strukturdaten erfolgt.

**Abbildung 45:**   Der Entscheidungsbaum gliedert sich in die Zweige <true jeweils Endpunkt des Entscheidungsbaumes, d.h. es sind keine weiteren Felder daran ge- knüpft.

Schnittstellenbeschreibung Elektronische Sammelerklärung (eSE)

**<titel V="Erklärung zur persönlichen Leistungserbringung"/>** **<text_liste>**

**</text_liste>** **<bool_einfach>**

**</bool_einfach>**

**bool_einfach (Entscheidungsbaum - einfach)**
...
Textuelle Beschreibung des zu erklärenden

Einfacher Entscheidungsbaum zur Bestätigung oder Ablehnung der Er klärung
...
rklärungen gefordert wird, ist daher in der vorlie
...
hkeit, die Zugehörigkeit zu einer Laborgemeinschaft zu
...
***<organization>***BeschreibungeinerOrganisationseinheit schränkung des Providers auf <organization>
...
Der Entscheidungsbaum beginnt mit dem bekanntenElement <bool_software>, welches bei Bestätigung des Software-Einsatzes eine Identifizierung der Software nach sich zieht.
...
zukönnen.DerKontextlässtsichdabei
...
[3]Im Rahmen der Schnittstellenentwicklung wurden folgende Sammelerklärungen analy siert und sind zum Teil beispielhaft in der Dokumentation verwend KVHB, KVH, KVN, KVNO, KVT, KVWL,
