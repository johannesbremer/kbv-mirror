...
# ANTRAG AUF ZERTIFIZIERUNG  SCHNITTSTELLE FÜR DRITTE GEMÄß §
...
Rechtsform anzugeben] Systempfleger vom Antragssteller abweicht] [x] [x] [x]Übergabe
...
suchradius - Suchparameter leistungsmerkmal ) - Suchparameter ) - Suchparameter  suchradiusBehandlungstermin umgesetzt:
...
- (3) Der Antragsteller akzeptiert die aktuellen Bedingungen aus dem Dokument „ Zertifizierung der Umsetzung der Vorgaben zur Nutzung der Schnittstelle gemäß §370a Abs. 2 SGB  V durch Nutzer der Schnittstelle“ [VERFAHRENSORDNUNG NACH § 370A ABS. 3 SGB V zukünftige Aktualisierungen dieser Richtlinie.
