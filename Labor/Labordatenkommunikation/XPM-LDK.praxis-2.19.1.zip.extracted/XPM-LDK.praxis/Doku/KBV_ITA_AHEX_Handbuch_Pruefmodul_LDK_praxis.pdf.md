...
|---|
| Handbuch Prüfmodul |
| [ KBV_ITA_AHEX_Handbuch_Pruefmodul _LDK_praxis] |
| Dezernat Digitalisierung und IT |
| 10623 Berlin, Herbert |
| Kassenärztliche Bundesvereinigung |
| Version Datum: Klassifizierung:  Extern |

-Lewin-Platz 2 1.0.4 28.01.2024 Status: In Kraft © Kassenärztliche Bundesvereinigung, Berlin 2024
...
Ordner 'Bin' Ordner 'Daten' Ordner 'Doku' Ordner 'Geprueft/Abgelehnt' Ordner 'Geprueft/NichtAbgelehnt' Ordner 'Konfig' Ordner 'Listen' Ordner 'Schema' ANWENDUNG DES PRÜFMODULS Technische Hinweise Prüfmodi des Prüfmoduls ...................................................................................................... 3.3.1 Abschnitt: Allgemeiner Teil 3.3.2 Abschnitt: Eingabedateien ................................................................................................... 11 3.3.3 Abschnitt: Ausgabedateien .................................................................................................. 11 3.3.4 Abschnitt: Schalter ............................................................................................................... 13 3.3.5 Umgebungsvariablen ........................................................................................................... 14 Arbeiten im Kommandozeilenmodus 3.4.1 Übergabeparameter ............................................................................................................. 15 3.4.2 Beispiele .............................................................................................................................. 16 Arbeiten mit grafischer Oberfläche ...................................................................................... 18 3.5.1 Prüfdatei selektieren ............................................................................................................ 18 3.5.2 Prüfung starten .................................................................................................................... 19 3.5.3 Optionen .............................................................................................................................. 20 3.5.4 Ansicht ................................................................................................................................. 20 Seite 3 von 34
...
Starten eines Java-Programms PRÜFUNGEN DES XPM-LDK Prüfungen bei Verwendung des Modus „Digitales Muster“ oder „Digitales Muster mit 5.1.1 Einhaltung Anzahl erlaubter Zeichen 5.1.2 Einhaltung der vorgegebenen Schr je Textfeld 5.1.3 Einhaltung des Formats bei Datumsfeldern......................................................................... 5.1.4 Für alle Textfelder ist die Option „Textlauf“ deaktiviert 5.1.5 Für alle Felder ist die Option „nur lesend“ gesetzt 5.1.6 Für alle Felder ist die Option „sichtbar“ gesetzt 5.1.7 Das Formular wird gegen die PDF/A-3a – Spezifikationen validiert 5.1.8 Es wird geprüft, ob alle Felder vorhanden und korrekt benannt sind Prüfungen im Prüfmodus „Abgleich zwischen digitalem Muster und LDT“.......................... 5.2.1 Übergreifend 5.2.2 Prüffälle für Muster 10 ......................................................................................................... 5.2.3 Prüffälle für Muster 10A Prüfungen im Prüfmodus „LDT“ bzw. „LDT Verzeichnisprüfung“ Seite 4 von 34
...
| Digitales Muster | -c, -x, -f Optional: | StartPruefungDigitaleMuster.bat und |
|---|---|---|
| Digitales Muster mit | -s, -x, -e, | VerzeichnisPruefungDigitaleMuster.bat VerzeichnisPruefungDigitaleMuster.sh |
| Abgleich zwischen | -c, -y, -f | StartPruefungDigitaleMust StartPruefungDigitaleMusterVsLDT.sh |
...
*3.3.1.1* *Installationsverzeichnis*  ***Das Installationsverzeichnis wird im Element „*** pruefpfad “ festgelegt.

***z.B.:*** <pruefpfad>./</pruefpfad>

*3.3.1.2* *Prüfdatenverzeichnis*  ***Das Verzeichnis mit Prüfdateien wird im Element „*** pruefdaten “ festgelegt.

<pruefdaten>Daten/</pruefdaten> ***z.B.:***

*3.3.1.3* *Geprüft - OK - Verzeichnis*  ***Bei eingeschalteter Option – m wird die geprüfte Datei mit Status ‘ok’ in dieses Ver-***  ***zeichnis kopiert. Pfadangabe erfolgt im Element „ okdaten “.***
...
-s, -m, - v, -h StartPruefungDigitaleMuster.sh Verzeichnisprüfung -m, -c -h, -v digitalem Muster und erVsLDT.bat ***Seite 9 von 34***
...
| kann | in der |  | Konfigurationsdatei | im | Element | „ | log_datei | | “ | angegeben | werden. |
|  | eventuellen | fehlerhaften |  |  | Programmablauf | |  | befinden | sich | in | dieser |
...
| 3.3.1.8 |  | Datensatzbesch |  | reibung |  |  |  |  |  |  |  |
| Die |  | Datensatzbeschreibung |  | LDT3.0 | wird | in Form | einer |  | XML- |  | Schemadatei |
...
| 3.3.1.9 |  | Warnungen |  |  |  |  |  |  |  |  |  |
| Diese | Einstellung | | ermglöicht | es, das |  | Protokollieren | | der | Warnungen | | ein- |
|  | schalten. Die | Konfiguration | | wird | im | Element | „warnungen“ | | fes |  | tgelegt. |
|  | Wertebereich: „ja“, | „nein“. |  |  |  |  |  |  |  |  |  |
| z.B.: |  | <warnungen>ja</warnungen> |  |  |  |  |  |  |  |  |  |
| 3.3.1.10 |  | Begrenzung | der |  | Fehlermeldungen | |  |  |  |  |  |
|  | Standardmg | ißäbegrenzt | das | XPM_ | LDK | die | gemeldeten | | Fehler | einer |  |
|  | dungsnummer | auf | eine | festgelegte | | maximale | | Anzahl. | Die |  | maximale |
| nach | Prüfprojekt | variieren | und | beträgt | in | der | Regel | zwischen | 30 | und 50. | Diese |
| lung | dient | der | Übersichtlichkeit | | eines |  | Fehlerprotokolls, | | um | die | Liste |
| schen | Fehlern | zu | überladen. | Die |  | standardmäßige | |  | Begrenzung | kann | ein- |
|  | schaltet | werden. |  |  |  |  |  |  |  |  |  |
...
Bei eingeschalteter Option – m wird die geprüfte Datei mit Status ‘abgelehnt’ bzw. ‘ab- bruch’ in dieses Verzeichnis kopiert. Pfadangabe erfolgt im Element „ fehlerdaten “. Bei jedem Prüflauf wird eine Protokolldatei geschrieben. Der Pfad der Protokolldatei kann in der Konfigurationsdatei im Element „ log_datei “ angegeben werden. Bei einem eventuellen fehlerhaften Programmablauf befinden sich in dieser Datei Informationen zur genauen Fehlerursache. Die Menge der zu prüfenden Dateien kann über das Element “ eingegrenzt Die Menge der zu prüfenden PDF -Dateien kann über das Element „ eingegrenzt werden. Die Datensatzbeschreibung LDT3.0 wird in Form einer XML- Schemadatei spezifiziert. Die Pfadangabe zur XML Schemadatei wird im Element „ pruefschema “ festgehalten. Hinweis: Solle in der Pfadangabe des Schemas das ‘%’ -Zeichen verwendet werden, so muss dieses durch die Zeichenkette ‘%25’ ersetzt werden. Diese Einstellung ermöglicht es, das Protokollieren der Warnungen ein-  bzw. auszu- schalten. Die Konfiguration wird im Element „warnungen“ Wertebereich: „ja“, „nein“. Begrenzung der Standardmäßig begrenzt das XPM_ LDK die gemeldeten Fehler einer bestimmten Mel- dungsnummer auf eine festgelegte maximale Anzahl. Die maximale Anzahl kann j nach Prüfprojekt variieren und beträgt in der Regel zwischen 30 und 50. Diese Einstel lung dient der Übersichtlichkeit eines Fehlerprotokolls, um die Liste nicht mit systemati schen Fehlern zu überladen. Die standardmäßige Begrenzung kann ein-  und ausge schaltet werden. ***Seite 10 von 34***
...
Alles, was dazu benötigt wird, ist der Adobe Reader®, der kostenlos unter  [https://get.adobe.com/de/reader/](https://get.adobe.com/de/reader/) heruntergeladen werden kann. XPM_LDK erzeugt  PDF Dokumente, die vom Acrobat Reader® ab der Version 5.0 und höher angezeigt  werden können.
...
**Tabelle 2: ErrorLevel**   So wird bei einer Prüfdatei mit dem Namen ‘Test.xml’ und dem Errorlevel 1 der Name  „Warnung_Test.xml.Fehler.pdf“ für die Fehlerliste vergeben.
...
|---|---|---|---|---|---|---|---|---|---|
| Jedes | Element | der |  | Konfigurationsdatei | | darf | Umgebungsvariablen | | |
| Diese | | Umgebungsvariablen | | | müssen | der JavaVM | jedoch | über den |  |
| – D | übergeben | | werden. | Nach dem | Einlesen | der | Konfigurationsdatei | | werden |
|  | bungsvariablen | | durch | ihre | Werte | ersetzt. Findet | das | XPM_LDK | eine |
| le | nicht, | wird der | Prüflauf | | abgebrochen. |  |  |  |  |
| Mit | Hilfe | von |  | Umgebungsvariablen | kann | mehreren | Benutzern |  | eine separate |
| zur | Verfügung |  | gestellt | werden, | die auf | eine | einzige | Installation | zugreifen. |
|  | Beispiel: |  |  |  |  |  |  |  |  |
...
| einer |  | Batchdatei | bzw. einem | | Shellskript: |  |  |  |  |
...
| Jetzt | muss | nur | noch dafür |  | gesorgt | werden, dass | die |  | Umgebungsvariablen |
|  | bekannt | sind. |  |  |  |  |  |  |  |
| Über | den | folgenden | Aufruf |  | werden die |  | Umgebungsvariablen | unter | gleichem |
| dem |  | XPM_LDK | bekannt | gegeben. | |  |  |  |  |
| java | - | DINSTALLATION=%INSTALLATION% | |  |  | - | DUMGEBUNG=%UMGEBUNG% ... |  |  |
| 3.4 | Arbeiten | im | Kom |  | mandozeilenmodus |  |  |  |  |
| Das | Prüfmodul | | kann als | ein |  | kommandozeilenorientiertes | |  | Programm |
| Der | Lauf | des | Prüfmoduls | wird | mithilfe | von | Übergabeparametern | | gesteuert. |
|  | Auflistung | aller |  | Übergabeparameter. | |  |  |  |  |
...
Jedes Element der Konfigurationsdatei darf Umgebungsvariablen enthalten. Diese Umgebungsvariablen müssen der JavaVM jedoch über den Übergabeparameter D übergeben werden. Nach dem Einlesen der Konfigurationsdatei werden die Umge- bungsvariablen durch ihre Werte ersetzt. Findet das XPM_LDK eine Umgebungsvariab- le nicht, wird der Prüflauf abgebrochen. Mit Hilfe von Umgebungsvariablen kann mehreren Benutzern eine separate Umgebung zur Verfügung gestellt werden, die auf eine einzige Installation zugreifen. In der Konfigurationsdatei wird der Prüfpfad folgendermaßen festgelegt: Die zwei Umgebungsvariablen INSTALLATION und UMGEBUNG müssen entweder in einer Batchdatei bzw. einem Shellskript: set INSTALLATION=C:\ set UMGEBUNG=LDT.Praxis oder in der aufrufenden Applikation entsprechend gesetzt werden. Jetzt muss nur noch dafür gesorgt werden, dass die Umgebungsvariablen der JavaVM bekannt sind. Über den folgenden Aufruf werden die Umgebungsvariablen unter gleichem Namen dem XPM_LDK bekannt Arbeiten im Das Prüfmodul kann als ein kommandozeilenorientiertes Programm gestartet werden. Der Lauf des Prüfmoduls wird mithilfe von Übergabeparametern gesteuert. Es folgt eine Auflistung aller Übergabeparameter.***Seite 14 von 34***
...
| -x | Der Parameter – Der Parameter darf nicht gleichzeitig mit |
| -y | Der Parameter – Dieser Parameter darf nicht gleichzeitig mit dem Parameter Bsp: |
...
-Kernels aus und beendet sich anschließend. Wird außer diesem Übergabe- parameter auch noch die Konfigurationsdatei (Übergabepara meter -c) angegeben, so wird zusätzlich die Versionsnummer des Prüfpaketes ausgegeben. Datei ste- hen, die vom Prüfmodul bearbeitet wird. Der Inhalt des Zip Archivs darf nur Prüfdateien enthalten. Dieser Übergabepara meter ist optional. x aktiviert die Prüfung der digitalen Muster. Der Pfad zum PDF wird mit – f %PFAD% übergeben, außer bei der Verzeichnisprüfung. y aufgerufen werden. f ./DigitaleMuster y aktiviert den PDF- LDT abgleich zwischen der PDF -Datei, deren Pfad hinter diesem Parameter angegeben wird und der LDT-Datei, deren Pfad hinter dem Parameter angegeben wird. aufgerufen werden. -y ./DigitaleMuster/xyz.pdf f ./LDT/Z0112345.ldt***Seite 16 von 34***
...
3.2.2.3. Beispiel 3: Prüfen e ines Verzeichnisses (ohne automatisches Beenden)  ***Übergabeparameter:***
...
3.2.2.4. Beispiel 4: Setzen des Pfades und des Formates einer Ausgabeliste  ***Übergabeparameter:***
...
3.2.2.5. Beispiel 5: Prüfen einer PDF – Datei  ***Übergabeparameter:***
...
3.2.2.6. Beispiel 5: Vergleich einer PDF – Datei mit einer LDT Datei  *- c Konfig\ konfig.xml – f Daten\ Z01Auftrag.ldt – y Daten\ Muster_10.pdf*
...
|---|---|---|---|---|---|---|---|---|---|---|
| Die | grafische | Oberfläche | | stellt | eine | Alternative | | zum |  | Kommandozeilen-Programm |
| Es | können | sowohl | Verzeichnisse | als | auch |  | Zip-Archive | geprüft |  | werden. |
| 3.5.1 | Prüfdatei | | selektieren |  |  |  |  |  |  |  |
| Bitte | drücken | Sie den | jeweiligen | | ‘...’-Knopf | und | wählen | Sie | die | gewünschte |
| aus. |  |  |  |  |  |  |  |  |  |  |
| Die | Modi „PDF | Formal“ | und | „PDF | gegen | LDT“ | sind | auswählbar, | | sobald |
| und | eine | LDT-Datei | ausgewählt | | wurde. |  |  |  |  |  |
| Ist | lediglich | eine | PDF-Datei |  | ausgewählt, | kann | nur | der Modus | „PDF | Formal“ |
| werden. |  |  |  |  |  |  |  |  |  |  |
| Ist | lediglich | eine | LDT-Datei |  | ausgewählt, | kann | nur | der Modus | „Nur | LDT“ |
| werden. |  |  |  |  |  |  |  |  |  |  |
...
Arbeiten mit grafischer Oberfläche Die grafische Oberfläche stellt eine Alternative zum Kommandozeilen-Programm dar. Es können sowohl Verzeichnisse als auch Zip-Archive geprüft werden. Prüfdatei selektieren Bitte drücken Sie den jeweiligen ‘...’-Knopf und wählen Sie die gewünschte Prüfdatei Die Modi „PDF Formal“ und „PDF gegen LDT“ sind auswählbar, sobald eine PDF-Datei und eine LDT-Datei ausgewählt wurde. Ist lediglich eine PDF-Datei ausgewählt, kann nur der Modus „PDF Formal“ verwendet Ist lediglich eine LDT-Datei ausgewählt, kann nur der Modus „Nur LDT“ ausgewählt Seite 18 von 34
...
Während der Prüfung zeigt der Fortschrittsbalken den aktuellen Fortschritt.     Nach erfolgter Prüfung erscheint eine Meldung mit dem entsprechenden Prüfstatus:
...
| 3.5.4 | Ansicht |  |  |  |  |  |  |
| Unter | „Ansicht“ | kann | die | Fehlerstatistik | und | das Prüfprotokoll | aufgerufen |

**XPM-LDK.praxis**  Handbuch Prüfmodul

[KBV_ITA_AHEX_Handbuch_Pruefmodul_LDK_praxis] * Version 1.0.4

Unter den Optionen kann das Prüfmodul konfiguriert werden. Unter „Ansicht“ kann die Fehlerstatistik und das Prüfprotokoll aufgerufen werden.Seite 20 von 34
...
‘ – Xmx300m’ ***erlaubt der Java Laufzeitumgebung einen Hauptspeicher Der Parameter***  ***von bis zu 300 MB zu reservieren. Diese Option garantiert einen stabilen Programmlauf***  ***bei Abrechnungsdateien in der Größenordnung bis ca. 300 MB.***
...
## Starten des Prüfmoduls aus einem Java-Programm
...
### Prüfungen bei Verwendung des Modus „Digitales Muster“ oder
...
### Einhaltung Anzahl erlaubter Zeichen
...
### Einhaltung der vorgegebenen Schriftgrößen je Textfeld
...
### Einhaltung des Formats bei Datumsfeldern
...
### Für alle Textfelder ist die Option „Textlauf“ deaktiviert
...
### Für alle Felder ist die Option „nur lesend“ gesetzt
...
### Für alle Felder ist die Option „sichtbar“ gesetzt

Das Prüfmodul prüft, ob bei allen Feldern die Option „sichtbar“ aktiviert ist. Die Optionen  „Ausgeblendet“, „Sichtbar, aber drucken nicht möglich“ oder „Unsichtbar, aber Drucken  möglich“ dürfen nicht gesetzt sein. Bei einem Verstoß, gibt das Prüfmodul einen Fehler  zurück.
...
|  | 5.1.7 | Das Formular | wird | gegen | die | PDF/A-3a | – | Spezifikationen | |
|---|---|---|---|---|---|---|---|---|---|
| Das | Prüfmodul | | validiert die | PDF-Datei | | gegen die | PDF/A3a | – | Spezifikation. |
|  | validität | gibt das | Prüfmodul | einen | Hinweis | aus. |  |  |  |
|  | 5.1.8 | Es wird | geprüft, | ob alle | Felder |  | vorhanden | und | korrekt |
| Das |  | Prüfmodul | prüft, ob | alle | Felder | entsprechend | den | Vorgaben | des |
|  | vorhanden | sind | und alle | Felder | korrekt | benannt | sind. | Bei einem | Verstoß |
|  | modul | einen Fehler | aus. |  |  |  |  |  |  |
...
Das Formular wird gegen die PDF/A-3a – Spezifikationen validiert Das Prüfmodul validiert die PDF-Datei gegen die PDF/A3a – Spezifikation. Bei Nicht- validität gibt das Prüfmodul einen Hinweis aus. Es wird geprüft, ob alle Felder vorhanden und korrekt benannt Das Prüfmodul prüft, ob alle Felder entsprechend den Vorgaben des techn. Handbuchs vorhanden sind und alle Felder korrekt benannt sind. Bei einem Verstoß gibt das Prüf- modul einen Fehler aus. Seite 25 von 34
...
### Prüfungen im Prüfmodus „Abgleich zwischen digitalem Muster und
...
Das Prüfmodul prüft, ob der maschinenlesbare Teil des Inhalts des PDF-Formularfelds  „3103_Geburtsdatum“ mit dem Inhalt des LDT-Felds mit Feldkennung „3103“ identisch  ist. Ist dies nicht der Fall wird ein entsprechender Hinweis ausgegeben.
...
| Das |  | Prüfmodul | prüft, | ob der |  | maschinenlesbare | | Teil | des | Inhaltes | des |
|  |  |  | „4110_VersicherungsschutzEnde“ | | | mit | dem | Inhalt des |  | LDT-Felds | mit |
|  | „4110“ | identisch | ist. | Ist | dies | nicht der | Fall | wird ein |  | entsprechender | |
|  | 5.2.1.9 |  |  | Kostenträgerkennung | ist | in | beiden | Dateien |  | identisch |  |
| Das |  | Prüfmodul | prüft, | ob der | Inhalt | des |  | PDF-Formularfelds | | „4111_ |  |
|  | nung“ | mit dem | Inhalt | des | LDT-Felds | mit | Feldkennung | | „4111“ | identisch | ist. |
| der | Fall | wird | ein | entsprechender | | Hinweis | | ausgegeben. |  |  |  |
|  | 5.2.1.10 |  |  | VersichertenID | ist | in | beiden | Dateien |  | identisch |  |
| Das |  | Prüfmodul | prüft, | ob der | Inhalt | des |  | PDF-Formularfelds | |  | „3119_VersichertenID“ |
| dem | Inhalt | | des | LDT-Felds mit |  | Feldkennung | „3119“ | identisch | | ist. | Ist dies |
| wird | ein |  | entsprechender | | Hinweis |  | ausgegeben. |  |  |  |  |
|  | 5.2.1.11 |  |  | Versichertenart | ist | in | beiden | Dateien |  | identisch |  |
| Das |  | Prüfmodul | prüft, | ob der | Inhalt | des |  | PDF-Formularfelds | |  | „3108_Versichertenart“ |
| dem | Inhalt | | des | LDT-Felds mit |  | Feldkennung | „3108“ |  | identisch | ist. | Ist dies |
| wird | ein |  | entsprechender | | Hinweis |  | ausgegeben. |  |  |  |  |
|  | 5.2.1.12 |  | Besondere | | Personengruppe | | ist | in | beiden | Dateien | identisch |
| Das |  | Prüfmodul | prüft, | ob der | Inhalt | des |  | PDF-Formularfelds | |  |  |
|  |  |  | „4131_BesonderePersonengruppe“ | | | mit | dem | Inhalt | des | LDT-Felds | mit |
|  | „4131“ | identisch | ist. | Ist | dies | nicht der | Fall | wird ein |  | entsprechender | |
|  | 5.2.1.13 |  |  | DMP-Kennzeichnung | | ist | in | beiden | Dateien |  | identisch |
| Das |  | Prüfmodul | prüft, | ob der | Inhalt | des |  | PDF-Formularfelds | |  |  |
|  |  |  | „4132_DMP_Kennzeichnung“ | | mit | dem | Inhalt | des | LDT-Felds | mit | Feldkennung |
|  | identisch | ist. | Ist | dies nicht | der | Fall | wird | ein | entsprechender | | Hinweis |
|  | 5.2.1.14 |  | Abgleich | des | ASV | und |  | TSS-Kennzeichens | |  |  |
| Ist | der | Inhalt | des | PDF-Feldes | |  |  | „0000_weitere_Kennzeichen“ | | = | 1, dann |
| Feld | mit |  | Feldkennung | 7303 | = 8 | sein. | Die | Prüfung wird | für | alle | vorhandenen |

**XPM-LDK.praxis**  Handbuch Prüfmodul

[KBV_ITA_AHEX_Handbuch_Pruefmodul_LDK_praxis] * Version 1.0.4

PLZ(PDF) = LDT FK 3112 und Ort(PDF) = LDT FK 3113 Ist das nicht der Fall, wird ein entsprechender Hinweistext ausgegeben. 5.2.1.8 Der maschinenlesbare Teil des Felds „VersicherungsschutzEnde“ identisch mit dem Inhalt des LDT-Felds FK 4110 Das Prüfmodul prüft, ob der maschinenlesbare Teil des Inhaltes des PDF-Formularfelds „4110_VersicherungsschutzEnde“ mit dem Inhalt des LDT-Felds mit Feldkennung „4110“ identisch ist. Ist dies nicht der Fall wird ein entsprechender Hinweis ausgegeben. 5.2.1.9 Kostenträgerkennung ist in beiden Dateien identisch Das Prüfmodul prüft, ob der Inhalt des PDF-Formularfelds „4111_ Kostentraegerken- nung“ mit dem Inhalt des LDT-Felds mit Feldkennung „4111“ identisch ist. Ist dies nicht der Fall wird ein entsprechender Hinweis ausgegeben. VersichertenID ist in beiden Dateien identisch Das Prüfmodul prüft, ob der Inhalt des PDF-Formularfelds „3119_VersichertenID“ mit dem Inhalt des LDT-Felds mit Feldkennung „3119“ identisch ist. Ist dies nicht der Fall wird ein entsprechender Hinweis ausgegeben. Versichertenart ist in beiden Dateien identisch Das Prüfmodul prüft, ob der Inhalt des PDF-Formularfelds „3108_Versichertenart“ mit dem Inhalt des LDT-Felds mit Feldkennung „3108“ identisch ist. Ist dies nicht der Fall wird ein entsprechender Hinweis ausgegeben. Besondere Personengruppe ist in beiden Dateien identisch Das Prüfmodul prüft, ob der Inhalt des PDF-Formularfelds „4131_BesonderePersonengruppe“ mit dem Inhalt des LDT-Felds mit Feldkennung „4131“ identisch ist. Ist dies nicht der Fall wird ein entsprechender Hinweis ausgegeben. DMP-Kennzeichnung ist in beiden Dateien identisch Das Prüfmodul prüft, ob der Inhalt des PDF-Formularfelds „4132_DMP_Kennzeichnung“ mit dem Inhalt des LDT-Felds mit Feldkennung „4132“ identisch ist. Ist dies nicht der Fall wird ein entsprechender Hinweis ausgegeben. Abgleich des ASV und TSS-Kennzeichens Ist der Inhalt des PDF-Feldes „0000_weitere_Kennzeichen“ = 1, dann muss das LDT Feld mit Feldkennung 7303 = 8 sein. Die Prüfung wird für alle vorhandenen Untersu- Seite 28 von 34
...
### Betriebsstättennummer muss mit LDT-Feld FK 0222 oder FK 0201

### identisch sein

Das Prüfmodul prüft, ob der Inhalt des PDF-Formularfelds  „0000_Betriebsstaettennummer“ in den LDT-Feldern mit Feldkennung „0222“ oder  „0201“ vorhanden ist. Ist dies nicht der Fall wird ein entsprechender Hinweis ausgege-  ben.

### 5.2.1.16

### Lebenslange Arztnummer muss mit LDT FK 0212 oder FK 0223 iden-
...
### Ausstellungsdatum muss in beiden Dateien übereinstimmen
...
### KBV-Prüfnummer muss in beiden Dateien übereinstimmen
...
### Laborauftragsnummer muss in beiden Dateien übereinstimmen
...
|  | 5.2.1.21 |  |  | Ausnahmeindikation | | muss | in | beiden | Dateien | | identisch |
|---|---|---|---|---|---|---|---|---|---|---|---|
| Das | Prüfmodul | | prüft, | ob der | Inhalt | des |  | PDF-Formularfelds | |  |  |
| in | dem | LDT-Feld | mit | Feldkennung |  | „4229“ | vorhanden | ist. | Ist | dies | nicht der |
|  | entsprechender | | Hinweis | | ausgegeben. | |  |  |  |  |  |
|  | 5.2.1.22 | Das |  | Geschlecht | muss | in | beiden |  | Dateien |  | übereinstimmen |
| Das | Prüfmodul | | prüft, | ob |  |  |  |  |  |  |  |
|  | a) Das |  | PDF-Feld |  | „3110_Geschlecht_W“ | |  | angekreuzt |  | ist. In | dem Fall |
|  | Feld | mit | der | Feldkennung | | 3110 | den Wert | „W“ | haben. | |  |
|  | b) Das | PDF-Feld | |  | „3110_Geschlecht_M“ | |  | angekreuzt |  | ist. In | dem Fall |
|  | Feld | mit | der | Feldkennung | | 3110 | den Wert | „M“ | haben. |  |  |
|  | c) Das |  | PDF-Feld |  | „3110_Geschlecht_W“ | | | und |  | „3110_Geschlecht_M“ | |
|  |  | sind. In | dem | Fall | muss das | LDT-Feld | | mit der |  | Feldkennung | 3110 |
|  |  | haben. |  |  |  |  |  |  |  |  |  |
|  | d) In | allen | anderen | fällen | muss | der | Wert | des | LDT-Felds |  | gleich „U“ |
|  | 5.2.1.23 |  | Diagnose | muss | in | beiden | Dateien |  | identisch |  | sein. |
| Das | Prüfmodul | | prüft, | ob der | Inhalt | des |  | PDF-Formularfelds | |  | „4207_Diagnose/ |
|  | diagnose“ | im | LDT-Feld | mit | Feldkennung | | „4207“ | vorhanden | | ist. Ist | dies nicht |
| wird | ein |  | entsprechender | | Hinweis |  | ausgegeben. |  |  |  |  |
| Da | das | Feld | „Diagnose“ | im | LDT | mehrfach |  | vorkommen | kann, | wird | dieses |
|  | prüft, | dass | zunächst | das | erste Feld | FK | 8200 | ausgelesen | | wird | und geprüft |
|  | Inhalt des |  | LDT-Feldes | in | der | Zeichenkette | im |  | PDF-Feld |  | „4207_Diagnose/ |
|  | agnose“ | vorkommt. | | Kommt | das | LDT-Feld | im | PDF-Feld | vor, | wird | im PDF-Feld |
|  | fundene | Text | temporär | eliminiert. | | Diese | Prozedur | wird |  | wiederholt | bis alle |
|  | miniert | sind | oder keine |  | Felder im | LDT | mehr | übrig | sind. | Die | Prüfung wurde |
| wenn | der | Text im | PDF | vollständig | | eliminiert | | werden | konnte. | |  |
| Dabei | wird | davon |  | ausgegangen, | | dass | Wörter | im | digitalen | Muster | immer |
|  | enden. | Wörter | über | mehrere | Zeilen | werden | somit | nicht |  | unterstützt. | |
|  | 5.2.1.24 |  | Abgleich |  | Abnahmedatum | |  |  |  |  |  |
| Das |  | Prüfmodul | prüft, | ob das |  | Abnahmedatum | im |  | maschinenlesbaren | | Teil |
|  | PDF-Feldes |  |  | „8129_Abnahmedatum“ | | mit | dem | LDT-Feld | mit |  | Feldkennung |
| tisch | ist. | Die | Prüfung | wird | für jedes |  | Vorkommen | von | „Material“ | | wiederholt |
|  | bestanden | wenn | für | jedes | Objekt | positiv | getestet |  | wurde. |  |  |
...
Ausnahmeindikation muss in beiden Dateien identisch sein Das Prüfmodul prüft, ob der Inhalt des PDF-Formularfelds „4229_Ausnahmeindikation“ in dem LDT-Feld mit Feldkennung „4229“ vorhanden ist. Ist dies nicht der Fall wird ein entsprechender Hinweis ausgegeben. Das Geschlecht muss in beiden Dateien übereinstimmen Das Prüfmodul prüft, ob Das PDF-Feld „3110_Geschlecht_W“ angekreuzt ist. In dem Fall muss das LDT- Feld mit der Feldkennung 3110 den Wert „W“ haben. Das PDF-Feld „3110_Geschlecht_M“ angekreuzt ist. In dem Fall muss das LDT- Feld mit der Feldkennung 3110 den Wert „M“ haben. Das PDF-Feld „3110_Geschlecht_W“ und „3110_Geschlecht_M“ angekreuzt sind. In dem Fall muss das LDT-Feld mit der Feldkennung 3110 den Wert „X“ In allen anderen fällen muss der Wert des LDT-Felds gleich „U“ Diagnose muss in beiden Dateien identisch sein. Das Prüfmodul prüft, ob der Inhalt des PDF-Formularfelds „4207_Diagnose/ Verdachts- diagnose“ im LDT-Feld mit Feldkennung „4207“ vorhanden ist. Ist dies nicht der Fall wird ein entsprechender Hinweis ausgegeben. Da das Feld „Diagnose“ im LDT mehrfach vorkommen kann, wird dieses Feld so ge- prüft, dass zunächst das erste Feld FK 8200 ausgelesen wird und geprüft wird, ob der Inhalt des LDT-Feldes in der Zeichenkette im PDF-Feld „4207_Diagnose/ Verdachtsdi- agnose“ vorkommt. Kommt das LDT-Feld im PDF-Feld vor, wird im PDF-Feld der ge- fundene Text temporär eliminiert. Diese Prozedur wird wiederholt bis alle Textteile eli- miniert sind oder keine Felder im LDT mehr übrig sind. Die Prüfung wurde bestanden wenn der Text im PDF vollständig eliminiert werden konnte. Dabei wird davon ausgegangen, dass Wörter im digitalen Muster immer am Zeilenende enden. Wörter über mehrere Zeilen werden somit nicht unterstützt. Abgleich Abnahmedatum Das Prüfmodul prüft, ob das Abnahmedatum im maschinenlesbaren Teil des Inhalts des PDF-Feldes „8129_Abnahmedatum“ mit dem LDT-Feld mit Feldkennung „7278“ iden- tisch ist. Die Prüfung wird für jedes Vorkommen von „Material“ wiederholt und gilt als bestanden wenn für jedes Objekt positiv getestet wurde. Ist das nicht der Fall, wird ein entsprechender Hinweis ausgegeben. Seite 30 von 34
...
### Die Abnahmezeit muss in beiden Dateien identisch sein.
...
### Ist „Eilt“ angekreuzt, muss LDT FK 8501=2 sein
...
### Abgleich Auftragsnummer des Einsenders
...
### Prüffälle für Muster 10

Die folgenden übergreifenden Prüffälle gelten für Muster 10.

### 5.2.2.1 Abgleich Kontrolluntersuchung

Das Prüfmodul prüft, dass wenn das PDF-Formularfeld  „4231_Kontrolluntersuchung_bekannte_Infektion“ angekreuzt ist, das LDT-Feld mit der  Feldkennung „4231“ den Wert 1 besitzt. Ist dies nicht der Fall wird ein entsprechender  Hinweis ausgegeben.
...
Das Prüfmodul prüft, ob der Inhalt des PDF-Formularfelds  „0000_Erstveranlasser_BSNR“ in einem der LDT-Felder mit Feldkennung „4217“ oder  „4225“ vorhanden ist. Ist dies nicht der Fall wird ein entsprechender Hinweis ausgege-  ben.
...
x ein oder mehrere Untersuchungsanforderungen im LDT-Auftrag vorhanden sind,

x Pro Untersuchungsanforderung können die Auftragsinformationen den Feldken-  nungen 7365 & 7366 oder 8412 & 8411 oder 8434 enthalten sein,

x Ist eine der genannten Kombinationen im Objekt „Untersuchungsanforderung“  vorhanden, können die jeweils anderen Kombinationen in diesem Objekt nicht  mehr vorkommen.
...
c) Wenn PDF-Feld „4221_belegaerztliche_Behandlung“ angekreuzt, dann LDT-  Feld 4221 = 4
...
**Beispiel: Im PDF sind die Felder „4205_Auftrag2“, „4205_Auftrag6“ und**  „4205_Auftrag35“ angekreuzt. Im LDT wird geprüft, ob folgende Felder vorhanden sind:  „8410=2“, „8410=6“ sowie „8410=35“.
