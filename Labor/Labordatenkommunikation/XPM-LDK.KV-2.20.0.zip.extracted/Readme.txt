Programm LDK-Prüfmodul für die inhaltliche Prüfung der digitalen Muster 10 und 10A
+++++ Version: 2.20.0 +++++
...
Im Ordner XPM-LDK.KV:
                            \\****------ Pruefung Digitale Muster 10 Inhaltlich -----****//
- StartPruefungPDF_Inhalt.bat         	Prüft ein digitales Muster (10/10A) (Batchdatei für Windows)
- StartPruefungPDF_Inhalt.sh          	Prüft ein digitales Muster (10/10A) (Shellskript für Unix, Mac)
- VerzeichnisPruefungPDF_Inhalt.bat   	Prüft alle digitalen Muster eines Verzeichnisses (Batchdatei für Windows)
- VerzeichnisPruefungPDF_Inhalt.sh    	Prüft alle digitalen Muster eines Verzeichnisses (Shellskript für Unix, Mac)
