...
7.1Sektion (section) 7.1.1 7.1.2
...
Abschn itt „Administrative Daten“ Abschnitt „Anamnese Körpergröße Körpergewicht Raucher Blutdruck systolisch Blutdruck diastolisch Begleiterkrankungen Neu aufgetretene osteoporosebedingte Fraktur seit der letzten Dokumentation Lokalisation der osteoporosebedingten Fraktur Stürze seit der letzten Dokumentation Abschnitt „Sonstige Befunde Abschnitt „Medikamentöse Behandlung“ Abschnitt „Schulungen“ Schulung empfohlen (bei aktueller Dokumentation) Empfohlene Schulung wahrgenommen Abschnitt „Behandlungsplanung“
...
STURZPROPHYLAXEMAßNAHME EMPFOHLEN
...
12 13 15 16 16 17 17 17 18 18 19 20 20 20 21 21 21 22 23 23 24 24

25 25 26 26 27 27 28 28 29 29 30 32 33 34 34 35
...
Eine Sektion enthält die Abschnitte „Administrative Daten“, „Anamnese Befunde und nichtmedikamentöse Behandlung “, „ „Behandlungsplanung“

**6.1.1****caption**

Das Element <caption> besteht nur aus dem erforderlichen Kindelement <caption_cd>. Im DN-Attribut des Elements <caption_cd> werden die jeweiligen Abschnittsüberschriften „Administrative Daten“, „Anamnese und Befunddaten“, „ Behandlung “, „Schulung
...
Sonstige Befunde und nichtmedikamentöse Behandlung “, en“und „Behandlungsplanung“ angegeben.

Medikamentöse Behandlung “, „Schulung - und Befunddaten“, „
...
Für die Darstellung von Daten des Chronischen Rückenschmerzes („erstmalige Dokumentation“ un Verlaufsdokumentation) in XML wird ausschließlich die Sciphox-SSU observation verwendet. Das Element
...
<sciphox-ssu> hat drei Attribute, die mit den festen Werten vorbelegt sind: type =“observation“, *country =“de“,**version =“v1“. Damit wird gekennzeichnet, dass die Sciphox* verwendet wird. Der Coderahmen für das Element <content> mit Sciphox-SSU observation sieht demnach folgendermaßen aus:
...
Bei diesem Parameter enthält das Element den letzten 6 Monaten “ und im U
...
<sciphox:Ergebniswert> im V -Attribut die „ -Attribut den fest vorgeschriebenen Wert „

)

Anzahl der Stürze in {Anzahl} “.
...
Seite 30 von 37 / KBV / Schnittstellenbeschreibung Osteoporose / Version: 1.01 /
...
Der body der Verlaufsdokumentation enthält die gleichen Abschnitte und fast alle Parameter wie die „erstmalige Dokumentation“ sowie zusätzliche Parameter, die nur für die Verlaufsdokumentationen gelten. Ergänzend kommt der Abschnitt „ Parameter für die Verlaufsdokumentation erläutert.
...
In diesem Kapitel werden nur die speziellen
...
Bei diesem Parameter enthält das Element <sciphox:Ergebniswert> im V -Attribut die „ Dokumentation “ und im U

Als Beispiel sei hier folgender Code angegeben:

Seite 33 von 37 / KBV / Schnittstellenbeschreibung Osteoporose / Version: 1.01 / 12. August 2022

- Attribut den fest vorgeschriebenen Wert „

<sciphox:Ergebnistext> im V -Attribut die Feldbezeichnunggemäß

"/>

Stürze seit der letzten {Anzahl} “.
...
Der Abschnitt „ Sonstige Befunde und nichtmedikamentöse Behandlung “ „erstmaligen Dokumentation“, sieheKapitel 6.1.6.

**7.1.4****Abschnitt „****Medikamentöse Behandlung “**

Der Abschnitt „ Medikamentöse Behandlung “ Dokumentation“, sieheKapitel 6.1.7.
...
hat die gleiche Struktur wie in der
...
<sciphox:Beobachtung> <sciphox:Parameter DN="Empfohlene Schulung wahrgenommen"/> <sciphox:Ergebnistext V="Ja"/> </sciphox:Beobachtung>
...
Seite 36 von 37 / KBV /Schnittstellenbeschreibung Osteoporose / Version: 1.01 / 12. August 2022
