...
chronischer Rückenschmerz -13) oder im Falle einer Vertretung, welche in der
...
Wechselt der eingeschriebene Patient den dokumentierenden Arzt Folgedokumentation gekennzeichnet werden. Das Element Arztwechsel wird nicht in den Datensatz  übermittelt.

, muss das bei Erfassung der
...
Die textuellen Erläuterungen gelten für die in Tabelle 1
...
aufgeführten Parameter abhängig von der
...
arteriellen Verschlusskrankheit und/oder Risiken - *Bitte neu*
...
Für [DATUM] wird das Datum der Erstdokumentation im Format DD.MM.YYYY und für [FEV1-WERT]  -Wertes angegeben.
...
Für [ANZAHL_MONATE] wird die Anzahl der Monate angegeben, seitdem für den Parameter „Aktueller  FEV -Wert (alle sechs bis zwölf Monate)“ keine Angabe in „X Prozent des Soll1

-Wertes“ in den  vorherigen Dokumentationen erfolgt ist.
...
geringster körperlicher Belastung (normales Gehen, Ankleiden) (schnelles Laufen, Bergaufgehen, Treppensteigen nach dem Essen, bei Kälte, Wind oder psychischer Belastung)  bei Alltagsbelastung (Laufen, Treppensteigen), jedoch bei plötzlicher oder längerer physischer Belastung - Anwender die folgende Tabelle
...
-  Das System muss den folgenden Text als Hinweis zur Anzeige bringen, ohne den Workflow zu
- unterbrechen:
...
und Folgedokumentation) d zum anderen, ob es druckschmerzhaft ist. Ein von der
...
- 2. Das System muss sicherstellen, dass der Anwender zur Erstellung einer Erst - oder Folgedokumentation  die folgenden vier Parameter zur Berechnung des DAS-28-Scores („Aktuelle Krankheitsaktivität  28-Wert“ in [
- – DAS-
- EXT_ITA_VGEX_Plausi_eDMP_Rheumatoide Arthritis]) eingibt:
...
Postfachadresse Bereich) -Header (Kindelemente von cda:patient vergleiche [[ -ssu> -ssu> -ssu> -ssu> -ssu> -ssu> -ssu> angabe 52)
...
| [EXT_ITA_VGEX_Plausi_eDMP_Adipositas_ ] | Plausibilität eDMP Adipositas -  Kinder und |
...
Versorgung -Header, gültig ab dem 01.07.2018 allgemeinen Datensatz zur Zusammenführung der Anforderungen an strukturierte Behandlungsprogramme nach § 137f Abs. 2 SGB V KiJu Jugendliche die Entscheidung über den Zustand der Asthmakontrolle beschrieben. Schweregrades nach Korff Schweregrades der Depression
