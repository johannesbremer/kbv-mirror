...
set XPM_CLASS_PATH=%XPM_INSTALLATION_DIR%/Bin/jasperreports-fonts-6.12.2.jar;%XPM_INSTALLATION_DIR%/Bin/xpm-core-4.2.39.jar;%XPM_INSTALLATION_DIR%/Bin/xpm-dmp-depression-2026.2.0.jar
