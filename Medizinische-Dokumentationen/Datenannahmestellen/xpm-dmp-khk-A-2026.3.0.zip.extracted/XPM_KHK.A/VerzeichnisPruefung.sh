...
${XPM_JAVA_CALL} de.kbv.xpm.modul.dmp.khk.start.StartKonsoleAsatz -s -e -m -c ${KONFIG_ED}

echo Pruefe Verlaufsdokumentation

${XPM_JAVA_CALL} de.kbv.xpm.modul.dmp.khk.start.StartKonsoleAsatzVerlaufsDoku -s -e -m -c ${KONFIG_VD}
else
	echo " "
fi
