Programm KBV-Prüfmodul für EDMP Koronare Herzkrankheit Datenannahmestellen-Prüfung Version 2026.3.0 3/2026
...
- EinzelPruefungED.bat       Prüft eine erstmalige Dokumentation (Batchdatei für Windows)
- EinzelPruefungED.sh        Prüft eine erstmalige Dokumentation (Shellskript für Unix)
- EinzelPruefungVD.bat       Prüft eine Verlaufsdokumentation (Batchdatei für Windows)
- EinzelPruefungVD.sh        Prüft eine Verlaufsdokumentation (Shellskript für Unix)
- SetVariablen.bat     			 Wird beim Programmstart von den anderen Batchdateien aufgerufen
- SetVariablen.sh     			 Wird beim Programmstart von den anderen Skriptdateien aufgerufen
                             (Shellskript für Unix)
- StartePruefmodulED.bat     Startet eine grafische Benutzeroberfläche
                             für erstmalige Dokumentationsprüfung (Batchdatei für Windows)
- StartePruefmodulED.sh      Startet eine grafische Benutzeroberfläche
                             für erstmalige Dokumentationsprüfung (Shellskript für Unix)
...
- StartePruefmodulVD.sh      Startet eine grafische Benutzeroberfläche
                             für Verlaufsdokumentationsprüfung (Shellskript für Unix)
...
- Geprueft/Abgelehnt         Ablage bereits geprüfter AB-Dateien.
- Geprueft/NichtAbgelehnt    Ablage bereits geprüfter AB-Dateien.
