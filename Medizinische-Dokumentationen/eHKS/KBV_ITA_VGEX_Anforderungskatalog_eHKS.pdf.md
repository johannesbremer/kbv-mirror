...
Seite 1 von 10 / KBV / Anforderungskatalog Hautkrebs
...
|  | 2.1.2 |  | Vorbelegung | von | Feldern |  |  |  | 5 |
|  | 2.1.3 |  | Unterstützung | von |  | ergänzenden | Verträgen | der KVen | 5 |
|  | 2.1.4 |  | Plausibilitätenprüfung | | |  |  |  | 6 |
|  | 2.1.5 |  | Speichern | und | Archivieren | von |  | Dokumentationsdaten | 6 |
|  | 2.1.6 | Anlage | einer |  | eDokumentation | |  |  | 6 |
| 2.2 |  | Versicherteninformationen | | |  |  |  |  | 7 |
|  | 2.2.1 |  | Administratives | | Geschlecht | des | Patienten |  | 7 |
| 2.3 |  | Datenübermittlung |  |  |  |  |  |  | 7 |
|  | 2.3.1 |  | Anwendung | Prüfmodul | | (XPM) |  |  | 7 |
|  | 2.3.2 | Export | der | Daten |  |  |  |  | 7 |
|  | 2.3.3 |  | Verschlüsseln | der | Daten |  |  |  | 8 |
|  | 2.3.4 |  | Datenträgerbeschriftung | | | und |  | Transportbegleitzettel | 8 |

**3 REFERENZIERTE DOKUMENTE** **9**

Seite 2 von 10 / KBV / Anforderungskatalog Hautkrebs

-Screening (eHKS) / Version: 1.14 / 15. August 2025

Pflichtfunktionen und optionale Funktionen der Software ÄRZTLICHES DOKUMENTIEREN Allgemeine Funktionen Vollständigkeit der Eingaben aller Stamm Vorbelegung von Feldern Unterstützung von ergänzenden Verträgen der KVen Speichern und Archivieren von Dokumentationsdaten Anlage einer eDokumentation Administratives Geschlecht des Patienten Anwendung Prüfmodul (XPM) Export der Daten Verschlüsseln der Daten Datenträgerbeschriftung und Transportbegleitzettel
...
Seite 3 von 10 / KBV / Anforderungskatalog Hautkrebs

-Screening (eHKS) / Version: 1.14 / 15. August 2025

P2-30 Spezifikation für KIM der kv.digital des Schemas von 3.32 in 2.33 P1-60 Wertebereichs für den Parameter „Geschlecht des Patienten“ nach Änderung des Personenstandsgesetz (PstG) P1-11 von Parameter- bezeichnungen zum eVersandlistenmodul Versandlistenmoduls P1-10 Zertifizierungsrichtlinie der KBV entfallen Modul Bestätigungsschreibens eVersandlisten- Verfahren Pflichtfunktion korrigiert
...
Seite 4 von 10 / KBV / Anforderungskatalog Hautkrebs
...
| PFLICHTFUNKTION EHKS |  |
|---|---|
| P1-11 | Anzeige des Dokumentat ionsparameters „Verdachtsdiagno |

Die Software muss in der Bedienoberfläche den in der Plausibili tätsrichtlinie als „VerdachtsdiagnoseND“  (Feld 1.1.1) bezeichneten Parameter als „Verdachtsdiagnose Nicht - Dermatologe“ anzeigen.
...
Seite 5 von 10 / KBV / Anforderungskatalog Hautkrebs

-Screening (eHKS) / Version: 1.14 / 15. August 2025

Stamm- und Bewegungsdaten seND“
...
Seite 6 von 10 / KBV / Anforderungskatalog Hautkrebs
...
Seite 7 von 10 / KBV / Anforderungskatalog Hautkrebs
...
Seite 8 von 10 / KBV / Anforderungskatalog Hautkrebs
...
| [KBV_ITA_VGEX_Schnittstelle_eHKS] | Krebsfrüherkennungsrichtlinie – Hautkrebs- |
...
Vertragsärztlichen Versorgung eDMP/a-Datensatz Screening (eHKS) Dokumentation HautkrebsScreening telematik.de/spaces/KDK/pages/71095111/ Dokumente+zum+Download
