# PRUE FPAKET EDMP -CHRONISCHER  RUECKENSCHMERZ
...
|  |  | übergreifenden Prüffälle | Schnittstellenversion |
|  |  | an COPD- | 4.06 ist ab 01.04.2023 |
|  |  | Schnittstellenversion | zu verwenden |
|  |  | 4.06 |  |
| 08.11.2022 | KBV | Datumsanpassungen der |  |
|  |  | Prüffälle. |  |
|  |  | Ergänzung eines Testfalls |  |
|  |  | für die |  |
|  |  | Teilnahmeerklärung |  |
| 15.02.2021 | KBV | Datumsanpassungen der | Datumsanpassungen |
|  |  | Prüffälle. | wegen der |
|  |  |  | übergreifenden |
|  |  | Aufnahme eines Testfalls | Prüffälle. |
|  |  | für die | Schnittstellenversion |
|  |  | Testdatenvalidierung zur | 1.01 ist ab 01.04.2023 |
|  |  | Schnittstellenversion | zu verwenden. |
|  |  | 1.00 |  |
|  |  | Neuer Prüffall 3540 zur | Anpassung an |
|  |  | Umsetzung der | Änderungen im |
|  |  | übergreifenden | Anforderungskatalog. |
|  |  | Teilnahmeerklärung. |  |
|  |  | Redaktionelle |  |
|  |  | Bearbeitung von Prüffall |  |
|  |  | 3530 |  |
...
[Alle erforderlichen Unterlagen stehen im Internet zum Download unter](https://update.kbv.de/ita-update/)[ita-update bereit. In diesem](https://update.kbv.de/ita-update/) Zusammenhang berücksichtigen Sie bitte das Kapitel[Rerenzierte Dokumente.](https://update.kbv.de/ita-update/)
...
ben als eine Archivdatei verschlüsselt

**und Teilnahmeerklärung:**  müssen in -Archiv zu
...
Die Versichertendaten der Testpatienten enthalten alle für den jeweiligen Prüffall nötigen Angaben zu den  Daten des Versicherten und werden als XML-Dateien zur Verfügung gestellt. Die Archivdatei  (VSD_5.2.0_Testfaelle_Vn.n.zip) enthält für jeden Prüffall i folgenden XML-Dateien mit Versichertenstammdaten
...
n einem jeweils separaten Verzeichnis die
...
/ Version: 1.02 / 12. Februar 2024 -Kryptomodul (XKM)
...
Bei der Erfassung des Prüffalls soll Prüffall 3530, Szenario vier erfasst werden.
...
**2.** **Bestimmung des Schweregrads nach von Korff:**  Jeweils für die Erst- und Folgedokumentation die Antworten auf die Fragen des CPG Fragebogens  erfassen und den Schweregrad berechnen.   **CPG-FRAGEBOGEN**

Fragen

Erstdokumentation Verlaufsdokumentation 7
...
Quartalsweise 05.04.2023 06.04.2024
...
Jedes zweite Quartal 05.10.2023 06.07.2024
...
Automatische  Übernahme aus dem  in CPG-Fragebogen
...
Quartalsweise 05.10.2023 06.07.2024
...
Ungeplante ambulante oder stationäre

6  kreuzschmerzbedingte Akutbehandlung seit der  letzten Dokumentation

**Medikamente**

Aktuelle kreuzschmerzbedingte

Ja, länger als 12 Wochen Ja, länger als 12 Wochen  Schmerzmedikation: Opioidanalgetika

Aktuelle kreuzschmerzbedingte

Bei Bedarf

Nein  Schmerzmedikation: Nicht-Opioidanalgetika

**Schulung**

Bereits vor Einschreibung in das DMP an einer Ja

multimodalen Schulung teilgenommen

Kreuzschmerz-spezifische Schulung empfohlen Ja

Ja  (bei aktueller Dokumentation)

Kreuzschmerz-spezifische Schulung

War aktuell nicht möglich  wahrgenommen
...
CPG Item 3: Durchschnittliche Stärke der 5

4  Kreuzschmerzen in den letzten drei Monaten

CPG Item 5: Kreuzschmerzbedingte 6

4  Beeinträchtigung der alltäglichen Aktivitäten  (Ankleiden, Waschen, Essen, Einkaufen etc.) in  den letzten drei Monaten

Erreichung mindestens eines der individuell

Kein Ziel vereinbart  vereinbarten Ziele seit der letzten Dokumentation
...
**Aktionen, die durch den Antragsteller durchgeführt werden:** **1.** **Versichertendaten:**  Die Versichertendaten von Kai von und zu Oldenburg **Verweisquelle konnte nicht gefunden werden.**  **2.** **Anlegen einer Erst- und einer Verlaufsdokumentation** **INDIKATIONSÜBERGREIFENDE DATEN**
...
(Siehe Prüffall 10  Ersatzverfahren ) im Ersatzverfahren erfassen.
...
Chronischer  Rückenschmerz, COPD
...
COPD Ungeplante, auch notfallmäßige  (ambulant und stationär) ärztliche  Behandlung wegen COPD seit der letzten  Dokumentation   Stationäre notfallmäßige Behandlung  wegen COPD seit der letzten  Dokumentation

CR Ungeplante ambulante oder stationäre  kreuzschmerzbedingte Akutbehandlung  seit der letzten Dokumentation
...
Bei Bedarf 092,0 Prozent des Soll-
...
Je nach Auswahl des  Patienten 2,59 m
...
Kontrolle der korrekten Umsetzung von Teilen des Anforderungskataloges eDMP  [(KBV_ITA_VGEX_Anforderungskatalog_eDMP](https://update.kbv.de/ita-update/Medizinische-Dokumentationen/KBV_ITA_VGEX_Anforderungskatalog_eDMP.pdf)
...
**Prüfunterlagen** Screenshots / Videodateien / PDFs zum Nachweis der korrekten  Systemfunktionalität.  **Für Szenario vier ist ein Video einzureichen**
...
Es wird eine Erstdokumentation für einen noch nicht im System existierenden Patienten angelegt. Bei  Angabe der DMP-Fallnummer ist eine bereits existierende Nummer (z.B. 3511) einzugeben. Das System  [darf entsprechend der Anforderung P1-10 (siehe KBV_ITA_VGEX_Anforderungskatalog_eDMP](https://update.kbv.de/ita-update/Medizinische-Dokumentationen/KBV_ITA_VGEX_Anforderungskatalog_eDMP.pdf)[), die](https://update.kbv.de/ita-update/Medizinische-Dokumentationen/KBV_ITA_VGEX_Anforderungskatalog_eDMP.pdf) [bereits vergebene DMP-Fallnummer nicht akzeptieren](https://update.kbv.de/ita-update/Medizinische-Dokumentationen/KBV_ITA_VGEX_Anforderungskatalog_eDMP.pdf)[](https://update.kbv.de/ita-update/Medizinische-Dokumentationen/KBV_ITA_VGEX_Anforderungskatalog_eDMP.pdf)

**Szenario 2**

Der Patient wechselt den Arzt, z.B. aufgrund einer Vertretungsregelung. Nach Kenntnisnahme einer  entsprechenden Warnung gemäß Anforderung P1-12 (siehe  [KBV_ITA_VGEX_Anforderungskatalog_eDMP](https://update.kbv.de/ita-update/Medizinische-Dokumentationen/KBV_ITA_VGEX_Anforderungskatalog_eDMP.pdf)[), dass zu diesem Patienten keine Erstdokumentation](https://update.kbv.de/ita-update/Medizinische-Dokumentationen/KBV_ITA_VGEX_Anforderungskatalog_eDMP.pdf) [vorliegt, wird eine Verlaufsdokumentation angelegt.](https://update.kbv.de/ita-update/Medizinische-Dokumentationen/KBV_ITA_VGEX_Anforderungskatalog_eDMP.pdf)

**Szenario 3**

Die Daten werden vom Anwender für den Versand vorbereitet. Das System erzeugt eine Hinweismeldung  (Bildschirmkopie beilegen) bezüglich der Datenträgerbeschriftung und druckt einen  Transportbegleitzettel aus. Hier soll die Umsetzung der Anforderungen KP4-40 und KP4-41 (siehe  [KBV_ITA_VGEX_Anforderungskatalog_eDMP](https://update.kbv.de/ita-update/Medizinische-Dokumentationen/KBV_ITA_VGEX_Anforderungskatalog_eDMP.pdf)[) nachgewiesen werden.](https://update.kbv.de/ita-update/Medizinische-Dokumentationen/KBV_ITA_VGEX_Anforderungskatalog_eDMP.pdf)

**Szenario 4**

Dieses Szenario ist bei der Erfassung von Prüffall **3511** durchzuführen und besteht aus mehreren  Schritten.  **1.** **Anlage einer Erstdokumentation**  Zeigen Sie, dass das System dem Anwender den Ausdruck des Chronic Pain Grade (CPG)-Fragebogens  [ermöglicht gemäß Anforderung KP1-75 (siehe KBV_ITA_VGEX_Anforderungskatalog_eDMP](https://update.kbv.de/ita-update/Medizinische-Dokumentationen/KBV_ITA_VGEX_Anforderungskatalog_eDMP.pdf) Das System überprüft die Eingaben des CPG[-Fragebogens auf Plausibilität im Rahmen der](https://update.kbv.de/ita-update/Medizinische-Dokumentationen/KBV_ITA_VGEX_Anforderungskatalog_eDMP.pdf) Erstdokumentation und ermittelt aus dem Schmerz-Score und den Disability-Punkten den  Schweregrad nach von Korff.  Erfassen Sie die Antworten des CPG-Fragebogens. Zeigen Sie, dass das System dem Anwender den  Schweregrad nach von Korff gemäß Anforderung KP1-76, Punkt 4 anzeigt und den Anwender mit dem  vorgegebenen Hinweistext auffordert, zu entscheiden, ob mit der Einschreibung in das eDMP  chronischer Rückenschmerz fortgefahren werden soll (siehe
...
**2.** **Anlage einer Verlaufsdokumentation**  Zeigen Sie, dass das System bei der Auswahl der Parameter „Aktuelle kreuzschmerzbedingte  Schmerzmedikation: Nicht-Opioidanalgetika“ und „Beendigung der DMP Teilnahme vereinbart“ die  nähere Erläuterung gemäß Anforderung KP1-46 jeweils anzeigt wird (siehe  [KBV_ITA_VGEX_Anforderungskatalog_eDMP](https://update.kbv.de/ita-update/Medizinische-Dokumentationen/KBV_ITA_VGEX_Anforderungskatalog_eDMP.pdf) [Zeigen Sie, dass das freiwillige Ausfüllen des CPG](https://update.kbv.de/ita-update/Medizinische-Dokumentationen/KBV_ITA_VGEX_Anforderungskatalog_eDMP.pdf)-Fragebogens möglich ist, nach den aufgeführten  Fragen des Akzeptanzkriteriums 1 der Anforderung KP1-77. Zeigen Sie, dass das System dem  Anwender den Schweregrad nach von Korff gemäß Anforderung KP1-77, Punkt 2 anzeigt (siehe  [KBV_ITA_VGEX_Anforderungskatalog_eDMP](https://update.kbv.de/ita-update/Medizinische-Dokumentationen/KBV_ITA_VGEX_Anforderungskatalog_eDMP.pdf)
...
**Prüfunterlagen** PDF-Datei „TE_EWE_CR.pdf“ der indikationsübergreifenden Teilnahme- und  Einwilligungserklärung
...
Kreuzschmerz-spezifische Schulung empfohlen (bei aktueller
...
CPG Item 3: Durchschnittliche Stärke der Kreuzschmerzen in den

drei Monaten

CPG Item 5: Kreuzschmerzbedingte Beeinträchtigung der alltäglichen  Aktivitäten (Ankleiden, Waschen, Essen, Einkaufen etc.) in den letzten  drei Monaten

multimodalen Schulung
...
letzten Automatische Übernahme aus  dem CPG-Fragebogen
...
[KBV_ITA_VGEX_Anforderungskatalog_eDMP](https://update.kbv.de/ita-update/Medizinische-Dokumentationen/KBV_ITA_VGEX_Anforderungskatalog_eDMP.pdf)[](https://update.kbv.de/ita-update/Medizinische-Dokumentationen/KBV_ITA_VGEX_Anforderungskatalog_eDMP.pdf)

[EXT_ITA_VGEX_Plausi_eDMP_Ruecken](https://update.kbv.de/ita-update/Medizinische-Dokumentationen/Rueckenschmerz/EXT_ITA_VGEX_Plausi_eDMP_Ruecken.pdf)[](https://update.kbv.de/ita-update/Medizinische-Dokumentationen/Rueckenschmerz/EXT_ITA_VGEX_Plausi_eDMP_Ruecken.pdf)

[KBV_ITA_VHEX_CPG-Fragebogen](https://update.kbv.de/ita-update/Medizinische-Dokumentationen/Rueckenschmerz/KBV_ITA_VHEX_CPG-Fragebogen.pdf)
...
[EXT_ITA_VGEX_Plausi_eDMP_COPD](https://update.kbv.de/ita-update/Medizinische-Dokumentationen/COPD/EXT_ITA_VGEX_Plausi_eDMP_COPD.pdf)[](https://update.kbv.de/ita-update/Medizinische-Dokumentationen/COPD/EXT_ITA_VGEX_Plausi_eDMP_COPD.pdf)

[KBV_ITA_VGEX_Schnittstelle_eDMP_CR](https://update.kbv.de/ita-update/Medizinische-Dokumentationen/Rueckenschmerz/)[](https://update.kbv.de/ita-update/Medizinische-Dokumentationen/Rueckenschmerz/)
...
[XPM-Paket_CR](https://update.kbv.de/ita-update/Medizinische-Dokumentationen/Rueckenschmerz/)

[XPM-Paket_COPD](https://update.kbv.de/ita-update/Medizinische-Dokumentationen/COPD/)

[Austausch_von_XML-Daten_Vn.nn.ZIP](ftp://ftp.kbv.de/ita-update/Medizinische-Dokumentationen/Leitfaeden/)[4](ftp://ftp.kbv.de/ita-update/Medizinische-Dokumentationen/Leitfaeden/)

[KBV_ITA_RLEX_Zert](https://update.kbv.de/ita-update/Allgemein/KBV_ITA_RLEX_Zert.pdf)

[KBV_ITA_FMEX_AAZ_eDMP_CR](https://update.kbv.de/ita-update/Medizinische-Dokumentationen/Rueckenschmerz/)
...
[VSD_5.2.0_Testfaelle_Vn.n.zip](ftp://ftp.kbv.de/ita-update/Abrechnung/Pruefverfahren/)[5](ftp://ftp.kbv.de/ita-update/Abrechnung/Pruefverfahren/)
...
Seite 30 von 30 / KBV / Pruefpaket eDMP-

Chronischer Rueckenschmerz / Version: 1.02 / 12. Februar 2024