...
14 14 15 16 17 17 17 17 18 19 19 20 20 20 20 21 21 21 22 22 23 23 24 24 25
...
12 13 15 16 16 17 17 17 18 18 19 19 20 20 20 21 21 22 22 23 23
...
Eine Sektion enthält die Abschnitte „Administrative Daten“, „Anamnese „Medikamente“, „Schulung“, „Sonstige Behandlung“ und „Relevante Ereignisse“,enthalten, die jeweils in einem <paragraph>-Element untergebracht sind.
...
- und Befunddaten“, „Behandlungsplanung“und kann den Abschnitt
...
Seite 15 von 35 / KBV / Schnittstellenbeschreibung Chronischer Rückenschmerz / Version: 1.01 / 12. August 2022
...
*version =“v1“. Damit wird gekennzeichnet, dass die Sciphox*
...
Bei diesem Parameter enthält das Element <sciphox:Ergebniswert> im V - Attribut die „Schmerzstärke“ und im U - Attribut den fest vorgeschriebenen Wert „
...
Die Angabe der Schmerzstärke erfolgt ohne
...
Bei diesem Parameter enthält das Element <sciphox:Ergebniswert> im V - Attribut die „ und im U - Attribut den fest vorgeschriebenen Wert „ ohne Nachkommastelle. Bitte beachten Sie die Ersetzung der Anführungszeichen in den XML- / XSD-Dateien im DN -Attribut des Elements <sciphox:Parameter> durch &quot;.
...
Die Angabe der Funktionsfähigkeit erfolgt
...
Dieses Kapitel beschreibt den Abschnitt „Releva
...
Bei diesemParameter Behandlungen “ und im
...
enthält *U -Attribut d en fest vorgeschriebenen Wert „Anzahl*
...
<sciphox:Beobachtung> <sciphox:Parameter DN="Beendigung der DMP-Teilnahme vereinbart"/> <sciphox:Ergebnistext V="Ja"/> </sciphox:Beobachtung>
