...
Umwandlung der Versicherten- pauschalen in der Arztpraxis durch die Sub-GOP
...
Bestätigung der Regelungen zur 309. Beschlussfassung
...
*Sub-GOP* *Abrechnung der neuen Versichertenpauschalen* *Verwendung im Rahmen von Honorarsimulationen* *XML-Beispiel*
...
1.1.1.4**XML-Beispiel** Das vorliegende XML-Beispiel veranschaulicht die Verknüpfung und Systematik zwischen Versichertenpauschale und den altersklassenspezifischen Sub-GOP.
...
Abbildung des HA-EBM auf die EBM-Schnittstelle (GOS)Seite 6 von 9
...
### Fachärztliche Zusatzpauschale und PFG

Für fachärztliche Leistungen, die im Rahmen der Grundversorgung erbracht werden, wurden Zusatzpauschalen für die fachärztliche Grundversorgung Pauschale kann lungsfall keine der Grundversorgung untypische Leistungen abgerechnet wurden
...
Zusätzlich beinhalten diese, über die tungen, gegenseitige Ausschlüsse gegen die

### 1.3

### GOP-Art (KBV-/KV-intern)
...
im Behandlungsfall als Zuschlag abgerechnet werden, wenn im Behand-

. Perspektivisch ist vorgesehen, dass die GOP-Art auch für kv-spezifische Leis-

fachärztliche Grundversorgung hinausgehenden Leis- fachärztlichen Zusatzpauschalen

zusätzlich auf die jeweilige Schlüsseltabelle

### -Ausschluss

(PFG) eingeführt, z.B. 05220. Die
...
Abbildung des HA-EBM auf die EBM-Schnittstelle (GOS)Seite 8 von 9
...
derversorgungsbereichsspezifischen
