...
SDKT (Kostenträger- Stammdatei) 1.05 Datum: 12.03.2025 Kennzeichnung: Öffentlich Status: In Kraft © Kassenärztliche Bundesvereinigung, Berlin 20 25
...
ik_liste aktualisiert <dav> <ebs> als Kindelement Elementes <dav> versicherte_liste aktualisiert Hybrid -DRG Abrechnung keit> ergänzt einer F ehlinterpre- tation möglicher Angaben Element <gueltigkeit> KV Baden Württemberg bei Bezeichnung entfernt und bei kt_abrechnungsbereich hinzugefügt im Schema von //bezeichnung nach //kt_abrechnungsbereich ver- schoben Bewertungsfeld um eine Stelle erweitert Beschrei- bungstextes zum "vertrags_kv" Nach- frage aus KV 2006 Seite 2 von 60
...
| 1 | EINLEITUNG |  |  |  |  |  |  | 8 |
| 2 | DARSTELLUNG | | DES |  | WURZELELEMENTS | EHD |  | 8 |
...
| 3 | BESCHREIBUNG | | ELEMENT |  |  | KOSTENTRAEGER_LISTE |  | 20 |
...
|  | KBV_ITA_VGEX_Schnittstelle_SDKT | | * | Version 1.05 |  |  | Seite | 3 von 60 |

DARSTELLUNG DES WURZELELEMENTS EHD Element header ............................................................................................................................ 11 2.1.1 Element id ............................................................................................................................ 12 2.1.2 Element document_type_cd ................................................................................................ 12 2.1.3 Element service_tmr ............................................................................................................ 13 2.1.4 Element origination_dttm ..................................................................................................... 14 2.1.5 Element provider.................................................................................................................. 14 Element organization ............................................................................................ 14 2.1.6 Element interface ................................................................................................................. 15 Element id ............................................................................................................. 15 Element interface.nm ............................................................................................ 16 Element version .................................................................................................... 16 Element body ............................................................................................................................... 17 Element keytabs .......................................................................................................................... 17 2.3.1 Element keytab .................................................................................................................... 18 2.3.2 Element key ......................................................................................................................... 19 2.3.3 Element fkey ........................................................................................................................ 20 BESCHREIBUNG ELEMENT KOSTENTRAEGER_LISTE Element kostentraeger ................................................................................................................ 20 3.1.1 Element gueltigkeit .............................................................................................................. 23 3.1.2 Element letzte_aenderung ................................................................................................... 23 Element wirksamkeitsdatum ................................................................................. 24 Element erfassungsdatum .................................................................................... 24 3.1.3 Element vertrags_kv ............................................................................................................ 25 3.1.4 Element abrechnungsstelle ................................................................................................. 25 3.1.5 Element referenzkasse ........................................................................................................ 26 3.1.6 Element bezeichnung .......................................................................................................... 26 Element name ....................................................................................................... 27 Element sortierungsname ..................................................................................... 27 Element kurzname ................................................................................................ 27 IT in der Arztpraxis Schnittstellenbeschreibung SDKT (Kostenträger-Stammdatei)  S V E  R Z  E I C KBV_ITA_VGEX_Schnittstelle_SDKT * Version 1.05 Seite 3 von 60
...
| 5 | REFERENZIERTE | |  | DOKUMENTE |  |  |  | 60 |
|  | KBV_ITA_VGEX_Schnittstelle_SDKT | | * Version | 1.05 |  |  | Seite | 4 von 60 |

Element suchname ............................................................................................... 28 3.1.7 Element kostentraegergruppe ............................................................................................. 29 3.1.8 Element ik_liste.................................................................................................................... 29 Element ik ............................................................................................................. 30 3.1.9 Element existenzbeendigung .............................................................................................. 32 Element letztes_quartal ........................................................................................ 33 Element aufnehmender_kostentraeger ................................................................ 33 Element adresse_liste ..................................................................................................... 34 3.1.10.1 Element adresse ................................................................................................... 35 Element praxisnetz .......................................................................................................... 39 3.1.11.1 Element basiskasse .............................................................................................. 40 Element dav_liste/dav ...................................................................................................... 40 3.1.12.1 Element ik ............................................................................................................. 42 3.1.12.2 Element ebs .......................................................................................................... 43 ..................................................................................................................... 44 3.1.13.1 Element ik ............................................................................................................. 46 Element versicherte_liste ................................................................................................. 47 3.1.14.1 Element versicherte .............................................................................................. 47 .................................................................................................................... 49 3.1.15.1 Element wop_kv_liste/wop_kv .............................................................................. 50 Element bewertungsfeld_liste .......................................................................................... 51 3.1.16.1 Element bewertungsfeld ....................................................................................... 52 3.1.16.2 Element bewertungskriterium ............................................................................... 53 Element ortssuchname_liste ............................................................................................ 53 3.1.17.1 Element ortssuchname ......................................................................................... 53 Element gebuehrenordnung ............................................................................................ 55 Element kt_abrechnungsbereich_liste ............................................................................. 55 3.1.19.1 Element kt_abrechnungsbereich .......................................................................... 56 Element unz_kv_geltungsbereich_liste ........................................................................... 57 3.1.20.1 Element unz_kv_geltungsbereich ......................................................................... 58 ........................................................................................................................ 59 4.1.1 Zuordnung OID – Schlüsseltabelle ...................................................................................... 59 REFERENZIERTE DOKUMENTE IT in der Arztpraxis Schnittstellenbeschreibung SDKT (Kostenträger-Stammdatei) KBV_ITA_VGEX_Schnittstelle_SDKT * Version 1.05 Seite 4 von 60
...
|  |  | KBV_ITA_VGEX_Schnittstelle_SDKT | | * | Version 1.05 |  |  |  | Seite | 5 von 60 |

Tabelle 1: Element ehd ........................................................................................................ Tabelle 2: Element header Tabelle 3: Element id Tabelle 4: Element document_type_cd Tabelle 5: Element service_tmr Tabelle 6: Element origination_dttm Tabelle 7: Element provider Tabelle 8: Element organization Tabelle 9: Element id Tabelle 10: Element ............................................................................................................. Tabelle 11: Element id Tabelle 12: Element interface.nm Tabelle 13: Element version Tabelle 14: Element body Tabelle 15: Element keytabs Tabelle 16: Element keytab Tabelle 17: Element key Tabelle 18: Element fkey Tabelle 19: Element kostentraeger_liste Tabelle 20: Element kostentraeger ................................................................................. Tabelle 21: Element gueltigkeit ..................................................................................... Tabelle 22: Element letzte_aenderung........................................................................... Tabelle 23: Element wirksamkeitsdatum ........................................................................ Tabelle 24: Element erfassungsdatum Tabelle 25: Element vertrags_kv ..................................................................................... Tabelle 26: Element abrechnungsstelle ........................................................................ Tabelle 27: Element referenzkasse ................................................................................. Tabelle 28: Element bezeichnung ..................................................................................... Tabelle 29: Element name .................................................................................................... Tabelle 30: Element sortierungsname Tabelle 31: Element kurzname ........................................................................................... Tabelle 32: Element suchname ........................................................................................... Tabelle 33: Element kostentraegergruppe Tabelle 34: Element ik_liste ........................................................................................... Tabelle 35: Element ik ........................................................................................................ IT in der Arztpraxis Schnittstellenbeschreibung SDKT (Kostenträger-Stammdatei) T A B  N V E  N I S KBV_ITA_VGEX_Schnittstelle_SDKT * Version 1.05 Seite 5 von 60
...
|  | Tabelle 39: | Element |  |  | aufnehmender_kostentraege | | r ..................................................... |
...
| Tabelle | 58: | Element | versicherte_liste | |  |  | ........................................................................ |
| Tabelle | 59: | Element mitglieder |  |  |  |  | ....................................................................................... |
| Tabelle | 60: Element | wop |  |  |  |  | ...................................................................................................... |
| Tabelle | 61: | Element | wop_kv_liste |  |  |  | ................................................................................... |
| Tabelle | 62: | Element | wop_kv |  |  |  | ................................................................................................ |
| Tabelle | 63: | Element | bezirksstelle |  |  |  | ................................................................................. |
|  | Tabelle 64: | Element |  |  | bewertungsfeld_liste | | .................................................................. |
|  | Tabelle 65: | Element |  | bewertungsfeld |  |  | ............................................................................... |
|  | Tabelle 66: | Element |  | bewertungskriterium | |  | .................................................................... |
|  | Tabelle 67: | Element |  | ortssuchname_liste | |  | ...................................................................... |
| Tabelle | 68: | Element | ortssuchname |  |  |  | ................................................................................... |
| Tabelle | 69: | Element |  |  |  |  | gebuehrenordnung........................................................................... |
|  | Tabelle | 70: Element |  |  | kt_abrechnungsbereich_liste | | ................................................... |
|  | Tabelle 71: | Element |  |  | kt_abrechnungsbereich | | ................................................................ |

**IT in der Arztpraxis**  Schnittstellenbeschreibung SDKT (Kostenträger-Stammdatei)

**KBV_ITA_VGEX_Schnittstelle_SDKT * Version 1.05**

Tabelle 36: Element gueltigkeit ..................................................................................... 31 Tabelle 37: Element existenzbeendigung 32 Tabelle 38: Element letztes_quartal 33 Tabelle 39: Element aufnehmender_kostentraege 33 Tabelle 40: Element adresse_liste ................................................................................. 34 Tabelle 41: Element adresse 35 Tabelle 42: Element STR ...................................................................................................... Tabelle 43: Element HNR ...................................................................................................... Tabelle 44: Element POB ...................................................................................................... Tabelle 45: Element ZIP ...................................................................................................... Tabelle 46: Element CTY ...................................................................................................... Tabelle 47: Element STA ...................................................................................................... Tabelle 48: Element CNT ...................................................................................................... Tabelle 49: Element praxisnetz ....................................................................................... Tabelle 50: Element basiskasse ....................................................................................... Tabelle 51: Element dav_liste ......................................................................................... Tabelle 52: Element dav ...................................................................................................... Tabelle 53: Element ik ........................................................................................................ Tabelle 54: Element gueltigkeit ..................................................................................... Tabelle 55: Element ebs ...................................................................................................... Tabelle 56: Element ik ........................................................................................................ Tabelle 57: Element gueltigkeit ..................................................................................... Tabelle 58: Element versicherte_liste ........................................................................ Tabelle 59: Element mitglieder ....................................................................................... Tabelle 60: Element wop ...................................................................................................... Tabelle 61: Element wop_kv_liste ................................................................................... Tabelle 62: Element wop_kv Tabelle 63: Element bezirksstelle ................................................................................. Tabelle 64: Element bewertungsfeld_liste Tabelle 65: Element bewertungsfeld Tabelle 66: Element bewertungskriterium Tabelle 67: Element ortssuchname_liste Tabelle 68: Element ortssuchname ................................................................................... Tabelle 69: Element gebuehrenordnung........................................................................... Tabelle 70: Element kt_abrechnungsbereich_liste Tabelle 71: Element kt_abrechnungsbereichSeite 6 von 60


---

| Tabelle | 72: | Element | bedruckungsname |  |  | ............................................................................. |
|---|---|---|---|---|---|---|
| Tabelle | 73: | Element | gueltigkeit |  |  | ..................................................................................... |
| Tabelle | 74: | Element |  | unz_kv_geltungsbereich_liste | | ................................................. |
| Tabelle | 75: | Element |  | unz_kv_geltungsbereich |  | .............................................................. |

**IT in der Arztpraxis**  Schnittstellenbeschreibung SDKT (Kostenträger-Stammdatei)

**KBV_ITA_VGEX_Schnittstelle_SDKT * Version 1.05**

Tabelle 72: Element bedruckungsname 56 Tabelle 73: Element gueltigkeit ..................................................................................... 57 Tabelle 74: Element unz_kv_geltungsbereich_liste 57 Tabelle 75: Element unz_kv_geltungsbereich 58 Seite 7 von 60
...
Das Element <id> ist ein eindeutiger Instanz – Identifikator, mit welchem jedes XML – Doku- ment bzw. jede XML-Datei weltweit identifiziert werden kann. Jede XML-Datei hat eine andere  ID, und auch bei Korrekturen muss eine neue ID vergeben werden.
...
Die Definitionen der Schlüsseltabellen „Keytab“ sind im Anhang zu finden.
...
Verarbeitungsnummer (derzeitige KV-Interne Kassen- Nr. laut KBV-Schlüssel);  Zeichen, Seriennummer - 3 Zeichen);  Zeichen, Kassengruppe - 1 Zeichen, lfd. Nummer - 2 Zeichen);  Zeichen, Kassengruppe - 2 Zeichen, lfd. Nummer - 1 Zeichen);  Abrechnungsstelle - 2 Zeichen, Kassengruppe - 2 Zei- chen, lfd. Nummer - 1 Zeichen) Seite 22 von 60
...
Beschreibung: Im Element letzte_aenderung sind das wirksamkeitsdatum und das  erfassungsdatum enthalten.
...
-AEN-DATUM- Z8) - Stammsatzeröffnung oder Änderung (V=KK -MASCH- DATUM-Z8) Seite 24 von 60
...
Beschreibung: Das Element vertrags_kv enthält die KV-Nummer der KV, die mit der Kasse  den Vertrag geschlossen hat, und ist identisch mit der zahlungspflichtigen KV-Landesstelle.
...
Beschreibung: Das Element sortierungsname enthält den dreistelligen Namen zur Sortie- rung.
...
Beschreibung: Das Element ik enthält ein gültiges Institutionskennzeichen der Kassennum- mer. Pro Kasse sind mehrere Institutionskennzeichen möglich.
...
Beschreibung: Das Element gueltigkeit enthält den Gültigkeitszeitraum des Institutions- kennzeichens.
...
Beschreibung: Im Element existenzbeendigung ist enthalten, ob eine Kassen fusioniert  oder aufgelöst worden ist. Bei einer Fusion ist im V - Attribut der Wert „F“ enthalten, bei einer  Auflösung ist der Wert „A“ enthalten.
...
Beschreibung: Das Element aufnehmender_kostentraeger ist nur vorhanden, wenn es  sich um eine Fusion handelt. In diesem Fall enthält das Element die Kassennummer in welche  die Kasse fusioniert ist.

Alte Feldbezeichnung: Feldkennung AUFN-KK-VKNR (DA 100, 105, 900, 905), Feldkennung  2028 (DA 145), aufnehmender_kostentraeger (DA 146)
...
xs:string mat: YYYYQ) -QRT) Seite 33 von 60
...
Beschreibung: Im R-Attribut des Elements adresse wird angegeben ob es sich bei der Ad- resse um eine Postanschrift (Wert vom R- Attribut „ anschrift “) oder ein Postfach (Wert vom  R- Attribut „ postfach “) handelt. In den Kindelementen sind die eigentlichen Informationen  enthalten.
...
Alte Feldbezeichnung: Feldkennung STR-X30 (DA 100, 105, 900, 905), Feldkennung 2004  (DA 145), STR (DA 146)
...
Alte Feldbezeichnung: Feldkennung STR-X30 (DA 100, 105, 900, 905), Feldkennung 2004  (DA 145), HNR (DA 146)
...
Prüfung: Innerhalb einer dav_liste darf jede Datenannahmestellen nur einmal im R-Attribut  des Elementes dav auftreten: - ASV
...
für den Bund (R- Attribut enthält den Wert „ Bund “), das Land (R -Attribut enthält den Wert  „ Land “) und für die Kasse (R - Attribut enthält den Wert „ Kasse “) nur einmal auftreten.
...
EFN, FB3-Bund, FB3- Land, FB3-Kasse, NVI, HDRG (DAV-Typ) Landesebene / Bundesebene Seite 41 von 60
...
Beschreibung: Das Element gueltigkeit enthält das Gültigkeitsdatum des Institutions- kennzeichen der jeweiligen Datenannahmestelle.
...
Z7, ALLG-VS- FA-Z7, ALLG- VS-RV-Z7 xs:string F (Familien- versicherte), R (Rentner) constraints _typ   Seite 48 von 60
...
Beschreibung: Das Element wop enthält im V-Attribut ein gültiges WOP-Kennzeichen laut  Schlüsseltabelle.

Alte Feldbezeichnung: Feldkennung KZ_WOP
...
Kennzeichen zip Seite 49 von 60
...
Beschreibung: Das Element wop_kv_liste enthält alle für diese Kasse gültigen KV - Nummern.
...
Beschreibung: Das Element wop_kv enthält eine für diese Kassennummer gültige KV - Nummer.
...
Beschreibung: Das Element bewertungsfeld_liste enthält alle Bewertungsfelder. Die  Bewertungsfeldnummer (RT-Attribut des Elements bewertungsfeld) muss eindeutig sein.
...
ve dem Vorzeichen xs:positiveInteger Seite 52 von 60
...
**3.1.16.2 Element bewertungskriterium**  Beschreibung: Das V-Attribut des Element bewertungskriterium enthält die Bezeichnung  des Bewertungsfeldes zur weiteren Verarbeitung in vdx, speziell zum Ausweis im Formblatt  gegenüber den Kassen.
...
Beschreibung: Ähnlich dem Kassensuchnamen dient das Element ortssuchname  einem schnellen Auffinden eines Kostenträgers, wenn keine Versichertenkarte vor- liegt. Zu einem Kostenträger können mehrere Ortssuchnamen existieren. Die Angabe  des Ortssuchnamen richtet sich nach der Art des Kostenträgers.  Alte Feldbezeichnung: Feldkennung 2014 (DA 145), ortssuchname_liste (DA 146)
...
Beschreibung: Das Element bedruckungsname enthält den Namen der Kasse, der für die  Bedruckung der Scheine in der Arztpraxis verwendet wird.
...
2. z.B.: 1990-10-01..2006-09-30 Beginn und Endedatum der Gültigkeit des Ko stenträgerab- rechnungsbereichs.
...
Alte Feldbezeichnung: Feldkennung 2029 (DA 145), unz_kv_geltungsbereich_list e  (DA 146)
