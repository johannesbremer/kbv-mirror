BMP Schemadatei (Version 2.8, Stand Oktober 2025)
************************************************************************
...
Das XSD-Schema in der Version 2.8 ist der Spezifikation für einen bundeseinheitlichen Medikationsplan (BMP) gemäß § 31a SGB V
[EXT_ITA_VGEX_BMP_Anlage3] der Version 2.8 vom 01. Oktober 2025, zugeordnet. 
...
- bmp_V2.8.xsd							(Schemadatei)


2. Änderungshistorie
#############################################################################
Änderungen von Version 2.8 von Oktober 2025 zur Vorversion 2.7 von Januar 2025:
 - Folgende Korrekturen wurden vorgenommen: 
	- Versionsnummer 	(MP.v):			Attributwert angepasst (fixed="028")
	- Darreichungsform Code (MP.S.M.f):		Attributwert minLength=1 und maxLength=10 eingefügt sowie pattern angepasst
	- Wochentag 	(MP.S.M.wo):		Wochentag für die wöchentliche Dosierung eingeführt
	- Zwischenüberschrift	(MP.S.c): 	Enumeration erweitert um den Wert 425
	- Seitenzahl	(MP.a):		Maximale Angabe auf 5 erhöht
	- Gesamtzahl	(MP.z):		Maximale Angabe auf 5 erhöht
