...
xtension:hardware.value[x]:valueString xtension:software.value[x]:valueString Herstellerpreis:  t.code.codin g.code == „publisher price“ t.amount.value t.amount.currency
...
Höchstpreis:  t.code.coding.code == „maximum amount“ t.amount.value t.amount.currency Datensicherheit Datensicherheit digitalen Gesundheitsanwendungen mit sehr hohem Schutzbedarf" n:inapplicable.extension:inapplicableReason.value[x].value String value[x]
